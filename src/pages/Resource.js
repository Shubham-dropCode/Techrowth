        ...
        <div className={styles.resourcePage24}>
          <div className={styles.sliderParent}>
            ...
            <div className={styles.blog}>
              ...
              <div className={styles.toOvercomeTheContainer}>
                <p className={styles.theDairySectorWantedToBoo}>
                  The company executed an Emotional Marketing strategy to
                  increase engagement and bookings for AC buses. The strategy
                  included
                </p>
              </div>
              <div className={styles.emotionalMarketingPromotedContainer}>
                <ol className={styles.emotionalMarketingPromoted}>
                  <li>
                    ...
                    <span>
                      Lack of Amenities and Comfort - The company identified
                      that the lack of basic amenities and comfort was the main
                      reason for low engagement of AC buses.
                    </span>
                  </li>
                </ol>
              </div>
            ...
            <div className={styles.blog}>
              ...
              <div className={styles.toOvercomeTheContainer}>
                <p className={styles.theDairySectorWantedToBoo}>
                  ...
                  slow website loading, resulting in increased user engagement
                  on their website. The strategy involved a series of steps that
                  are as follows:
                </p>
              </div>
              <div className={styles.emotionalMarketingPromotedContainer}>
              ...
              <div className={styles.digitalMarekting}>
                ...
                <div className={styles.unlockThePotentialOfYourBWrapper}>
                  <div className={styles.unlockThePotential}>
                    ...
                    opportunities with our result-driven strategies. Our
                    extensive digital channels can help you reach a wider
                    audience, boost brand visibility, and drive growth.
                  </div>
                </div>
