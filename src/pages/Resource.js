          ...
          <div className={styles.categories}>
            <div className={styles.frameParent}>
              <div className={styles.frameGroup}>
                <button className={styles.latestPostWrapper}>
                  <div className={styles.latestPost}>Latest Post</div>
                </button>
                <button className={styles.popularPostWrapper}>
                  <div className={styles.latestPost}>Popular Post</div>
                </button>
              </div>
                ...
                <div className={styles.frameContainer}>
                  ...
                  <button className={styles.frameButton}>
                    <div className={styles.frameDiv}>
                      ...
                      />
                      <img
                        className={styles.businessAnalyticsIcon}
                        alt=""
                  ...
                  <div className={styles.frameParent12}>
                    ...
                    <div className={styles.locationParent}>
                      ...
                      <div className={styles.lusakaZambiaCoIzyaneInParent}>
                        ...
                        <div className={styles.mobileSupport}>
                          Bangalore, India - No.373, 1st floor, 2nd Phase, West
                          of Chord Road, Stage 2, Rajajinagar, Bengaluru,
                          Karnataka 560086
                        </div>
                      </div>
                    </div>
