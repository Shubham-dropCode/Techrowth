import styles from "./InterestedInSoftwareDevelopmen.module.css";
const InterestedInSoftwareDevelopmen = () => {
  return (
    <div className={styles.interestedinsoftwaredevelopmen}>
        ...
        <div className={styles.frameGroup}>
          <div className={styles.frameContainer}>
            <div className={styles.groupParent}>
              <img className={styles.frameChild} alt="" src="/group-816.svg" />
              <div className={styles.eCommerceParent}>
                ...
                <div className={styles.ourTeamWorksContainer}>
                  <p className={styles.ourTeamWorks}>
                    Our team works closely with you to understand your business
                    needs and deliver customized e-commerce solutions that drive
            ...
            <div className={styles.groupContainer}>
              <img className={styles.frameChild} alt="" src="/group-819.svg" />
              <div className={styles.mobileApplicationsParent}>
                ...
                <div className={styles.weSpecializeInContainer}>
                  <p className={styles.ourTeamWorks}>
                    We specialize in delivering exceptional user experiences for
                    mobile users, helping you reach your target audience and
            ...
            <div className={styles.frameDiv}>
              <img className={styles.frameChild} alt="" src="/group-814.svg" />
              <div className={styles.cmsParent}>
                <div className={styles.mobileApplications}>CMS</div>
                <div className={styles.weSpecializeInContainer}>
                  <p className={styles.ourTeamWorks}>
                    Our expert team ensures that your website is up-to-date and
                    running smoothly, so you can focus on growing your business.
                  </p>
                </div>
          ...
          <div className={styles.frameContainer}>
            <div className={styles.groupParent}>
              <img className={styles.frameChild} alt="" src="/group-817.svg" />
            ...
            <div className={styles.groupContainer}>
              <img className={styles.frameChild} alt="" src="/group-818.svg" />
              <div className={styles.webApplicationsParent}>
                ...
                <div className={styles.weHaveDevelopedContainer}>
                  <p className={styles.ourTeamWorks}>
                    ...
                    <b className={styles.websites}>$144 million in revenue.</b>
                  </p>
                </div>
              </div>
            </div>
            <div className={styles.groupContainer}>
              <img className={styles.frameChild} alt="" src="/group-815.svg" />
              <div className={styles.cmsParent}>
                <div className={styles.mobileApplications}>
      ...
      <div className={styles.interestedInSoftwareDevelopParent}>
        <div className={styles.frameParent2}>
          <div className={styles.toolsParent}>
            <b className={styles.interestedInSoftware}>Tools</b>
            <div
              className={styles.weAreProficient}
            >{`We are proficient in `}</div>
          </div>
          <div className={styles.groupParent4}>
            <img className={styles.frameChild3} alt="" src="/group-358.svg" />
            <img className={styles.frameIcon} alt="" src="/frame-846@2x.png" />
            <img className={styles.frameIcon} alt="" src="/frame-847@2x.png" />
            <img className={styles.frameIcon} alt="" src="/frame-848@2x.png" />
            <img className={styles.frameIcon} alt="" src="/frame-849@2x.png" />
            <img className={styles.frameIcon} alt="" src="/frame-1029@2x.png" />
            <img className={styles.frameIcon} alt="" src="/frame-1030@2x.png" />
            <img className={styles.frameChild3} alt="" src="/group-359.svg" />
          </div>
        </div>
      </div>
    </div>
...
export default InterestedInSoftwareDevelopmen;
